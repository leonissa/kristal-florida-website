...
const contactMethods = [
  {
    ...
    details: ['123 Wellness Boulevard', 'Suite 100', 'Miami, FL 33101'],
  },
  {
    label: 'Call Us',
    icon: (
    ...
    details: ['(305) 555-0199', 'Toll-Free: (800) 555-0199'],
  },
  {
    label: 'Email Us',
    icon: (
          ...
          <div className="grid md:grid-cols-5 gap-12">
            ...
            <div className="md:col-span-2">
              <div className="bg-gradient-to-br from-eternita-teal to-eternita-teal-dark rounded-3xl p-8 text-eternita-white sticky top-28">
                <h3 className="font-serif text-xl font-bold mb-4">Why Choose Eternita?</h3>
                <ul className="space-y-4">
                  {[
                    ...
                    'A serene, spa-like environment for total relaxation',
                  ].map((item, i) => (
                ...
                <div className="mt-8 pt-6 border-t border-white/20">
                  ...
                  <a href="tel:+13055550199" className="text-xl font-bold hover:text-eternita-coral-light transition-colors">
                    (305) 555-0199
                  </a>
                </div>
              </div>
      ...
      <section className="py-20 md:py-28">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="tel:+13055550199" className="btn-primary">
              Call to Book
            </a>
