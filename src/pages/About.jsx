...
const faqs = [
  ...
  },
  {
    ...
    a: 'Yes. We partner with trusted financing providers to offer flexible monthly payment options. Our treatment packages also provide excellent value for clients seeking ongoing care. Ask our team about current financing specials.',
  },
  {
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-4 text-eternita-gray text-sm md:text-base leading-relaxed">
                ...
                <p>
                  Today, Kristal's is home to a team of dedicated licensed professionals, each committed to continuing education and mastering the latest techniques. We invest in the best technology, the finest products, and — most importantly — genuine relationships with every client who walks through our doors in South Florida.
                </p>
                <p>
                  Whether you are a first-time visitor or a longtime member, you are not just a client at Kristal's. You are part of our family.
                </p>
              </div>
            </div>
