...
const values = [
  {
    ...
    desc: 'Every treatment at Eternita is supervised by licensed medical professionals. We invest in the latest FDA-cleared technology and adhere to the highest clinical standards in the industry.',
    icon: (
...
const faqs = [
  ...
  },
  {
    ...
    a: 'Unlike traditional day spas, a medical spa operates under the supervision of licensed medical professionals and offers clinical-grade treatments that go beyond the surface. At Eternita, every treatment is performed or overseen by registered nurses and nurse practitioners using advanced medical technology.',
  },
  {
      ...
      <section className="bg-gradient-to-br from-eternita-teal-dark via-eternita-teal to-eternita-teal-light py-20 md:py-28">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-eternita-white/70 max-w-2xl mx-auto text-sm md:text-lg">
            Eternita was founded with one belief — that everyone deserves access to medical-grade skincare in an environment that feels like a sanctuary.
          </p>
        </div>
      </section>
      ...
      <section className="py-20 md:py-28">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            ...
            <p className="text-eternita-gray mt-4 max-w-xl mx-auto text-sm md:text-base">
              Everything you need to know before your first visit to Eternita.
            </p>
          </div>
